  ...
  jQuery(document).ready(function(){
    (function($) {
      if(!has_social_form){
        ...
        socialLogins = $('<div class="newsociallogins" style="display:none; text-align: center;"><div style="clear:both;"></div></div>');
        if(loginForm.find('input').length > 0)
          loginForm.prepend("<h3 style='display: none; text-align:center;'>OR</h3>");
...
function new_fb_redirect() {
  ...
  $site_url = site_url();
  $site_url_back = "http%3A%2F%2Fmisihidupsehatdettol.com%2F%3Fsource%3Dfacebook%23thank_you";
